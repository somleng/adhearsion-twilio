...
module DeprecatedCallControllerHelpers
  include MockCall
...
RSpec.configure do |config|
  config.include(DeprecatedCallControllerHelpers, include_deprecated_helpers: true)

  config.before(include_deprecated_helpers: true) do
