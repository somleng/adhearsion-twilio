...
describe Adhearsion::Twilio::Configuration do
  ...
  describe "#voice_request_url" do
    ...
    context "given metadata" do
      def metadata
        super.merge(:voice_request_url => url)
      end
  ...
  describe "#voice_request_method" do
    ...
    context "given metadata" do
      def metadata
        super.merge(:voice_request_method => http_method)
      end
  ...
  describe "#status_callback_url" do
    ...
    context "given metadata" do
      def metadata
        super.merge(:status_callback_url => url)
      end
  ...
  describe "#status_callback_method" do
    ...
    context "given metadata" do
      def metadata
        super.merge(:status_callback_method => http_method)
      end
  ...
  describe "#auth_token" do
    ...
    context "given metadata" do
      def metadata
        super.merge(:auth_token => auth_token)
      end
